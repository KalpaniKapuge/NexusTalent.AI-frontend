...
import { adminNotifications as initialNotifications } from "../../../data/mockAdminData";
   ...
   return (
    <div>
      <PageHeader
        ...
        subtitle={`${unreadCount} unread system notification${
          unreadCount !== 1 ? "s" : ""
        }`}
        action={
      ...
      <Card>
        <div className="py-12 text-center">
          ...
          <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">
            Admin system notifications will appear here.
          </p>
        </div>
      </Card>
    );
